...
def get_file_bytes_2(dir_name, video_name, file_name):
    print("baidu 下载开始")
    start_time = time.time()
    remote_path = dir_root + r"/" + dir_name + r"/"+video_name+"/"+file_name
